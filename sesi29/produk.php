...
$produk = mysqli_query($connection, "SELECT *, produk.id, nama FROM produk JOIN supplier ON supplier_id = supplier.id;");
...
<body class="bg-secondary text-light">
    <div class="container-fluid">
        <nav class="navbar sticky-top navbar-expand-lg bg-secondary position-relative">
            ...
            <div class="collapse navbar-collapse position-absolute top-50 start-50 translate-middle" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active bg-dark text-light" aria-current="page" href="produk.php">Produk</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="position-absolute top-10 start-50 translate-middle-x my-2 py-3 px-5 bg-dark">
            ...
            <div class="text-center">
                <div class="text-center">
                    <a href="add_data/add_produk.php" class="btn btn-success">Tambah Data</a>
                </div>
            </div>
            <hr>
                    ...
                    <?php foreach ($produk as $key => $data) { ?>
                        <tr class="border">
                            ...
                            <td class="border text-center">
                                <a href="edit_data/edit_produk.php?id=<?php echo $data['id'] ?>" class="btn btn-warning btn-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                                        <path d="M12.146.146a.5.5 0 0 1 .708 0l3 3a.5.5 0 0 1 0 .708l-10 10a.5.5 0 0 1-.168.11l-5 2a.5.5 0 0 1-.65-.65l2-5a.5.5 0 0 1 .11-.168l10-10zM11.207 2.5 13.5 4.793 14.793 3.5 12.5 1.207 11.207 2.5zm1.586 3L10.5 3.207 4 9.707V10h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.293l6.5-6.5zm-9.761 5.175-.106.106-1.528 3.821 3.821-1.528.106-.106A.5.5 0 0 1 5 12.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.468-.325z" />
                                    </svg>
                                </a>
                                <a href="proses_delete/delete_data_produk.php?id=<?php echo $data['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this item?');">
    ...
    <!-- begin :: JS -->
    <script>
        let table = new DataTable('#table_produk');
    </script>
    <!-- end :: JS -->
